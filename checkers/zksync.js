...
import {sleep, readWallets, getBalance, getKeyByValue, newAbortSignal, getTokenPrice, saveData} from '../utils/common.js'
...
async function saveToCsv() {
    await saveData('zksync', columns, jsonData, csvData, csvWriter, p)
}
